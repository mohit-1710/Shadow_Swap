...
async function main() {
  ...
  const config: KeeperConfig = {
    ...
    programId: process.env.PROGRAM_ID || 'ESHkd14KmUUJthjVqKoh7JP1oVVMFJCqPPkpsrJrT5Kt',
    orderBookPubkey: process.env.ORDER_BOOK_PUBKEY || 'DneZLDgRwDoa7XViSEaAb9BGMj2R8frinJ3ydwAucyfz',
